    ...
    <table style="margin:auto; width: 800px; border: 1px solid black ;" >
        <tr>
            <td style="width:30%; vertical-align:top;">
                    <a href="bai06.php">Trang chủ</a><br>
                    <?php
                        if(isset($_SESSION["login"])){
                            echo "<a href='bai06.php?tthai=dangxuat'>Đăng xuất</a>";
                        }
                        elseif(isset($_SESSION["user"])){
                            echo "<a href='bai06.php?tthai=dangnhap'>Đăng nhập</a>";
                        }
                        else{
                            echo "<a href='bai06.php?tthai=dangky'>Đăng ký</a>";
                        }
                    ?>
            </td>
