...
<body>
    <?php
        if(isset($_REQUEST["btnDKy"]))
        {
            ...
            echo "click <a href='bai06.php'>vào đây</a> để trở về trang chủ nếu hệ thống không tự động chuyển";
            echo header("refresh:4; url = 'bai06.php'");
        }
        else{
            echo "<script>alert('Bạn không có quyền truy cập!')</script>";
            echo header("refresh:0; url = 'bai06.php'");
        }
    ?>
</body>
</html>